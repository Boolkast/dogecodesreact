export const AUTH_REQUEST = Symbol("AUTH_FULFILLED");
...
export const LOGOUT_REJECT = Symbol("LOGOUT_REJECT");
...
export const SOCKETS_CONNECTION_FULFILLED = Symbol('SOCKET_CONNECTION_FULFILLED')
export const SOCKETS_CONNECTION_REJECT = Symbol('SOCKET_CONNECTION_REJECT')
...
export const EDIT_USER_FULFILLED = Symbol('EDIT_USER_FULFILLED')
export const EDIT_USER_REJECT = Symbol('EDIT_USER_REJECT')